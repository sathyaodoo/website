...
class AttendanceOffLine(models.Model):
    _name = 'attendance.offline'
    _description = 'Attendance Offline Machine'
    _order = "datetime ,id"

    id_employee_device = fields.Char(string='Employee ID', help="The ID of the employee in the Offline machine")
    ...
    def create_offline_attendance(self):
