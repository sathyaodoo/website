...
class StockValuationLayer(models.Model):
    ...
    def _create_stock_variation_entry(self):
        ...
        try:
            ...
            # end_of_day = datetime(2026, 2, 14, 23, 29, 59)
            ...
            for company in all_companies:
                ...
                try:
                    ...
                    for group in grouped_data_current:
                        ...
                        brand_info = {
                            'categ_id': group.get('categ_id', [False, 'No Brand'])[0],
                            'brand_name': group.get('categ_id', [False, 'No Brand'])[1],
                            'value': brand_value,
                        }
    ...
    def _build_analytic_distribution(self, brand_data, total_value, company, period_name):
        ...
        for brand_info in brand_data:
            ...
            brand = self.env['product.category'].sudo().search([
                ('name', '=', brand_name),
            ], limit=1)
